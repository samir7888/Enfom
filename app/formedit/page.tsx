...
export default function FormEdit() {
  ...
  const [formFields, setFormFields] = useState<string[]>(
    formData.formFilled.split(',').map(f => f.trim())
  );

  // Styles State
  const [styles, setStyles] = useState<FormStyles>({
    main: { padding: 40, margin: 40, backgroundColor: '#FFFFFF', borderRadius: 8 },
    titleColor: { textColor: '#000000', fontSize: 20, fontWeight: '600', fontStyle: 'normal', textAlign: 'left' },
    inputLabel: { display: 'block', color: '#000000', fontSize: 14, fontWeight: '500', fontStyle: 'normal', alignment: 'left' },
    entry: {
  ...
  const colorPalette = [
    '#000000', '#808080', '#FF0000', '#FFA500', '#FFFF00',
    '#00FF00', '#0000FF', '#800080', '#FFFFFF', '#FFB6C1',
  ];
  ...
  // Computed
  const currentComponentLabel = componentList.find(c => c.key === currentComponent)?.label || '';
  ...
  const isImageField = (field: string): boolean => {
    ...
    return lower.includes('image') || lower.includes('photo') || lower.includes('upload');
  };
  ...
  const updateField = async (index: number, newValue: string) => {
    ...
    const isDuplicate = formFields.some((f, i) => i !== index && f.toLowerCase() === trimmed.toLowerCase());
    if (isDuplicate) {
  ...
  // Update style helper
  const updateStyle = useCallback(<K extends keyof FormStyles, P extends keyof FormStyles[K]>(
    section: K,
    property: P,
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex h-[calc(100vh-57px)] overflow-hidden">
        ...
        <div className="w-72 bg-white border-r border-gray-200 p-6 overflow-y-auto flex-shrink-0">
          <h2 className="text-2xl font-semibold text-gray-900 mb-1">Form Editor</h2>
          ...
          <h3 className="text-base font-semibold text-gray-900 mb-4">Components</h3>
          ...
          >
            ...
            <h2
              ...
              style={{
                ...
                textAlign: styles.titleColor.textAlign as React.CSSProperties['textAlign'],
              }}
            >
              {formData.formFor}
            </h2>
              ...
              {formFields.map((field, index) => (
                <div key={index}>
                  <label
                    ...
                    style={{
                      display: styles.inputLabel.display as React.CSSProperties['display'],
                      ...
                      textAlign: styles.inputLabel.alignment as React.CSSProperties['textAlign'],
                    }}
                  >
                    {field}
                  </label>
                    ...
                    <>
                      ...
                      <style jsx>{`
                        #field_${index}::placeholder {
                          ...
                          opacity: ${styles.entry.placeholderDisplay === 'visible' ? 1 : 0};
                        }
                      `}</style>
                    </>
                  )}
            ...
            <div
              className="mt-6 flex"
              style={{
                justifyContent: alignmentMap[styles.button.alignment] || 'flex-end',
              }}
            >
              <button
        ...
        <div className="w-80 bg-white border-l border-gray-200 p-6 overflow-y-auto flex-shrink-0">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-900">{currentComponentLabel}</h4>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('main', 'padding', parseInt(e.target.value) || 0)}
                    min="0"
                    max="100"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('main', 'margin', parseInt(e.target.value) || 0)}
                    min="0"
                    max="100"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('main', 'backgroundColor', e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('main', 'borderRadius', parseInt(e.target.value) || 0)}
                    min="0"
                    max="50"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-md space-y-2">
                    ...
                    {formFields.length === 0 && (
                      <div className="text-xs text-gray-500 py-2">No fields. Add one below.</div>
                    )}
                  </div>
                  ...
                  {showAddField ? (
                    <div className="mt-3">
                      ...
                      {addFieldError && (
                        <div className="text-xs text-red-500 mt-1">{addFieldError}</div>
                      )}
                    </div>
                  ) : (
                    <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('titleColor', 'textColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('titleColor', 'fontSize', parseInt(e.target.value) || 14)}
                    min="10"
                    max="48"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('titleColor', 'fontWeight', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('titleColor', 'fontStyle', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    {alignOptions.map((align) => (
                      <button
                        key={align.value}
                        onClick={() => updateStyle('titleColor', 'textAlign', align.value)}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('inputLabel', 'display', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('inputLabel', 'color', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('inputLabel', 'fontSize', parseInt(e.target.value) || 14)}
                    min="10"
                    max="24"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('inputLabel', 'fontWeight', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="300">Light (300)</option>
                    <option value="400">Normal (400)</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('inputLabel', 'fontStyle', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="normal">Normal</option>
                    <option value="italic">Italic</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('inputLabel', 'alignment', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-5 gap-2 mb-3">
                    {colorPalette.map((color) => (
                      <button
                        key={color}
                        onClick={() => updateStyle('entry', 'backgroundColor', color)}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('entry', 'textColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('entry', 'placeholderColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('entry', 'borderColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('entry', 'placeholderDisplay', e.target.value as 'visible' | 'hidden')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('entry', 'fontSize', parseInt(e.target.value) || 14)}
                    min="10"
                    max="24"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('entry', 'borderRadius', parseInt(e.target.value) || 0)}
                    min="0"
                    max="30"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('entry', 'borderWidth', parseInt(e.target.value) || 0)}
                    min="0"
                    max="10"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('button', 'backgroundColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateStyle('button', 'textColor', e.target.value)}
                      className="w-full h-10 p-1 border border-gray-300 rounded-r-md"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('button', 'fontSize', parseInt(e.target.value) || 14)}
                    min="10"
                    max="24"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('button', 'fontWeight', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="300">Light (300)</option>
                    <option value="400">Normal (400)</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateStyle('button', 'fontFamily', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('button', 'width', parseInt(e.target.value) || 100)}
                    min="50"
                    max="800"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateStyle('button', 'height', parseInt(e.target.value) || 40)}
                    min="20"
                    max="200"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    {alignOptions.map((align) => (
                      <button
                        key={align.value}
                        onClick={() => updateStyle('button', 'alignment', align.value)}
                        className={`flex-1 px-3 py-2 border rounded-md text-sm transition-colors ${
