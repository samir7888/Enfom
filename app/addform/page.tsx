...
export default function FormCreate() {
  ...
  const templateFields = React.useMemo(
    () => formState.formTemplate.split(',').map((f) => f.trim()).filter(Boolean),
  ...
  const handleEnableForm = () => {
    if (formState.paymentRequired) {
      setPayment((prev) => ({ ...prev, amount: formState.requiredPaymentAmount }));
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Navbar */}
      <nav className="fixed top-0 w-full bg-white 6px- py-3 flex items-center justify-between z-50 shadow-sm">
      ...
      {/* Main Container */}
      <div className="pt-14  w-full  max-w-7xl mx-auto flex  h-[calc(100vh-80px)]">
        {/* Left Panel */}
            ...
            {activeTab === 'general' && (
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  <h3 className="text-xl font-semibold text-gray-900">Form Create</h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormState((prev) => ({ ...prev, formName: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-3 bg-gray-50 rounded-md">
                      {templateFields.length > 0 ? (
                        ...
                        <span className="text-sm text-gray-500">No fields defined</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    ...
                    <div className="space-y-4">
                      <ToggleItem
                        ...
                        onChange={(checked) =>
                          setFormState((prev) => ({ ...prev, loginUserOnly: checked }))
                        }
                      />
                      <ToggleItem
                  ...
                  <div className="pt-4">
                    ...
                    <ToggleItem
                      ...
                      onChange={(checked) =>
                        setFormState((prev) => ({ ...prev, paymentRequired: checked }))
                      }
                      highlight
                    />
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFormState((prev) => ({
                                ...prev,
                                requiredPaymentAmount: parseFloat(e.target.value) || 0,
                              }))
                            }
                            step="0.01"
                            min="0"
        ...
        {/* Right Panel - Preview */}
        <div className="bg-white w-full rounded-lg shadow-sm p-8 overflow-y-auto">
          <div className="mb-6">
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-2xl p-8 max-w-lg w-full mx-4 shadow-2xl animate-slideUp">
            ...
            <div className="grid grid-cols-2 gap-4 bg-gray-50 p-5 rounded-lg mb-6">
              ...
              <div>
                <div className="text-xs text-gray-600 mb-1">Available Forms</div>
                <div className="text-sm font-semibold text-gray-900">
  ...
  return (
    <div
      className={`flex items-center justify-between py-3 ${
        highlight ? 'bg-amber-50 px-3 rounded-lg' : 'border-b border-gray-100 last:border-0'
      }`}
    >
      <span
